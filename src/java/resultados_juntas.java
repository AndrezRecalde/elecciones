 ...
 * @author root
 */
public class resultados_juntas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("op").equals("avance_responsables")) {
                
                CAU.Ingresar(id_usuario_session, 7);
                
                ArrayList<ClassResultadosAvanceEscrutinio> listado_avance_responsables = new ArrayList<ClassResultadosAvanceEscrutinio>();

                listado_avance_responsables = resDB.CargarAvanceASignacionResponsableJunta();

                session.setAttribute("listado_avance_responsables", listado_avance_responsables);
                response.sendRedirect("rep_resultados_avance_responsables.jsp");
            }

...
class ActasAllExport implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithColumnFormatting
{

    protected $dignidad_id, $canton_id, $parroquia_id;

    public function __construct(int $dignidad_id, int $canton_id, int $parroquia_id)
    {

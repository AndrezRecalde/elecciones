 ...
 */
public class srvlt_junta_insert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		int Xcod_recinto =Integer.parseInt(request.getParameter("txt_cod_recinto"));
           if(OBJ.Ingresar(Xfr_id_zona,Xcne_cod_junta,Xnum_junta,Xgenero,Xjunta_nombre,Xnum_electores_cne,Xnum_votaron,Xnum_no_votaron,Xnum_total_votaron,Xreceptada,Xresponsable,Xresponsable_telefono,Xcod_recinto)){
                if(request.getParameter("crear_nueva")!=null){
                    response.sendRedirect("junta_ingresar.jsp");
                }else{

...
<thead><tr><td colspan="2">Ingresar Cantón</td>
</tr>
</thead>
<tbody>
<tr >
...
if (session.getAttribute("lista_combo_provincia") == null) {
                                        response.sendRedirect("admin_controlador.srvlt_provincia_listar_combo?red=cantones_ingresar.jsp");
                                        return;
...
</td><td><input type="text" name="txt_nombre_canton" >
</td>
</tr>
<tr >
<td><b>Tiene circunscipciones</b>
</td><td><select name="txt_tiene_circunscipciones"><option value="1">SI</option><option value="0">NO</option></select>
</td>
</tr>
<tr >
<td><b>Canton Padre</b>
</td><td><input type="text" name="txt_fr_id_canton_pertenece" >
</td>
</tr>
<tr>

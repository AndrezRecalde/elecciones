...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_cantones_buscar_actualizar">         <center>
         <h1 class="titulo_h1">Control Electoral-Cantones</h1>
         <div class="contenedor_tabla"><table  class="clsTablaDatos form_style">

<thead>
<tr>
<td colspan="2">Actualizar registro cantones</td>
</tr>
</thead>
<tbody>
<tr>
<td>Ingrese el cod de canton de Cantones a buscar </td><td><input type="text" name="txt_cod_canton" required></td></tr>

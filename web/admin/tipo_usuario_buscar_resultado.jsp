...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_tipo_usuario_insert">         <center>
...
<thead><tr><td colspan="2">Detalles del Tipo de usuario</td></tr></thead>
<tbody>
<tr ><td><b>idtipo de usuario</b>
</td>
<td>
<input readonly type="text" name="txt_idtipo_usuario" value="<%= request.getParameter("txt_idtipo_usuario")%>">
</td>
</tr>

<tr ><td><b>nombre de tipo de usuario</b>
</td>
<td>
<input readonly type="text" name="txt_nombre_tipo_usuario" value="<%= request.getParameter("txt_nombre_tipo_usuario")%>">
</td>
</tr>

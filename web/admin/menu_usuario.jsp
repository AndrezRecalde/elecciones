...
<ul>
<li><a href='usuario_ingresar.jsp' target="contenido">INGRESAR usuario</span></a></li>
<li><a href='usuario_buscar_buscar.jsp' target="contenido">BUSCAR usuario</span></a></li>
<li><a href='usuario_actualizar.jsp' target="contenido">ACTUALIZAR usuario</span></a></li>
<li><a href='usuario_eliminar_buscar.jsp' target="contenido">ELIMINAR usuario</span></a></li>
<li class='last'><a href='admin_controlador.srvlt_usuario_listar_todos' target="contenido">ADMINISTRAR usuario</span></a></li></ul>
</li>
</ul>
</li>
</ul>

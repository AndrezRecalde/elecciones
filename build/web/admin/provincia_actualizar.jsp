...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_provincia_buscar_actualizar">         <center>
         <h1 class="titulo_h1">Datos-Provincias</h1>
         <div class="contenedor_tabla"><table  class="clsTablaDatos form_style">

<thead>
<tr>
<td colspan="2">Actualizar registro provincia</td>
</tr>
</thead>
<tbody>
<tr>
<td>Ingrese el CNE Cod Prov de Provincias a buscar </td><td><input type="text" name="txt_cne_cod_prov" required></td></tr>

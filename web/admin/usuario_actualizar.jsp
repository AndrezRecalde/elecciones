...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_usuario_buscar_actualizar">         <center>
         <h1 class="titulo_h1">Control Electoral-usuario</h1>
         <div class="contenedor_tabla"><table  class="clsTablaDatos form_style">

<thead>
<tr>
<td colspan="2">Actualizar registro usuario</td>
</tr>
</thead>
<tbody>
<tr>
<td>Ingrese el ID de usuario a buscar </td><td><input type="text" name="txt_idusuario" required></td></tr>

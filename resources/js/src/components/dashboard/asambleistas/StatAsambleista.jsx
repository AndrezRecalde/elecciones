...
import { IconArrowUpRight, IconBuildingBank, IconUsersGroup } from "@tabler/icons-react";

export const StatAsambleista = ({ classes, data }) => {
    ...
    return (
        <Paper withBorder p="md" radius="md">
            ...
            <Text c="dimmed" fz="sm">
                ...
                <Text fz={18} fw={700}>Asambleístas Nacionales</Text>
            </Text>

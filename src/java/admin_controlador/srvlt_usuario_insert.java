 ...
 */
public class srvlt_usuario_insert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (OBJ.Ingresar(Xnombres, Xusuario, Xfr_id_provincia, Xprovincia_nombre, Xfr_id_tipo_usuario, Xes_provincial, Xfr_id_canton, Xes_cantonal, Xtipo_usu_nombre, Xclave, Xactivo)) {
                if (request.getParameter("crear_nueva") != null) {
                    response.sendRedirect("usuario_ingresar.jsp");
                } else {

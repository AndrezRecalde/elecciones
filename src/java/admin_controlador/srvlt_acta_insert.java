 ...
 */
public class srvlt_acta_insert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		int Xfr_id_acta_estado =Integer.parseInt(request.getParameter("txt_fr_id_acta_estado"));
           if(OBJ.Ingresar(Xcod_provincia,Xcod_canton,Xcod_parroquia,Xcod_zona,Xfr_id_junta,Xfr_id_dignidad,Xcne_cod_acta,Xnum_validos,Xnum_no_voto,Xnum_blancos,Xnum_nulos,Xacta_usu_ing,Xacta_usu_mod,Xcuadrada,Xlegible,Xfr_id_acta_estado)){
                if(request.getParameter("crear_nueva")!=null){
                    response.sendRedirect("acta_ingresar.jsp");
                }else{

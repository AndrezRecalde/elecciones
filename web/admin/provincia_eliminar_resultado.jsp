...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_provincia_eliminar">         <center>
...
<thead>
<tr>
<td colspan="2">Elimninar Provincia</td>
</tr>
</thead>
<tbody>
...
<td><input type="text" name="txt_cne_cod_prov" readonly value="<%= request.getParameter("txt_cne_cod_prov")%>">
</td>
</tr>

<tr class="alt"> 
<td><b>Nombre</b></td>
<td><input type="text" name="txt_nombre_provincia" readonly value="<%= request.getParameter("txt_nombre_provincia")%>">
</td>
</tr>

<tr class="alt"> 
<td><b>num de vot de hombres</b></td>
<td><input type="text" name="txt_num_vot_hombres" readonly value="<%= request.getParameter("txt_num_vot_hombres")%>">
</td>
</tr>

<tr class="alt"> 
<td><b>num de vot de mujeres</b></td>
<td><input type="text" name="txt_num_vot_mujeres" readonly value="<%= request.getParameter("txt_num_vot_mujeres")%>">
</td>
</tr>

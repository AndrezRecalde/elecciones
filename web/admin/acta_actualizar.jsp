...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_acta_buscar_actualizar">         <center>
         <h1 class="titulo_h1">Datos-Actas</h1>
         <div class="contenedor_tabla"><table  class="clsTablaDatos form_style">

<thead>
<tr>
<td colspan="2">Actualizar registro acta</td>
</tr>
</thead>
<tbody>
<tr>
<td>Ingrese el idacta de Actas a buscar </td><td><input type="text" name="txt_idacta" required></td></tr>

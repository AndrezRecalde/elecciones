    ...
    <body>
        <%
            if (request.getParameter("tipo") != null) {
                ...
                File reportFile = new File(application.getRealPath("reportes/reporte_responsable_recintos.jasper"));
                Connection conn = conexion.getConexion();
                Map parameters = new HashMap();
                parameters.put("SUBREPORT_DIR", getServletContext().getRealPath("/"));
                parameters.put("id_canton", Integer.parseInt(request.getParameter("txt_cod_recinto")));

...
<html>
    ...
    <body>
         <form name="form1" action="admin_controlador.srvlt_junta_buscar_actualizar">         <center>
         <h1 class="titulo_h1">Datos-Juntas</h1>
         <div class="contenedor_tabla"><table  class="clsTablaDatos form_style">

<thead>
<tr>
<td colspan="2">Actualizar registro junta</td>
</tr>
</thead>
<tbody>
<tr>
<td>Ingrese el ID de Juntas a buscar </td><td><input type="text" name="txt_idjunta" required></td></tr>
